...
from pyecharts.charts import Bar, Liquid, Map, Line, Scatter
...
# -------------------- Load geojson for China map --------------------
with open("./china.json", "r", encoding="utf-8") as f:
    china_geojson = json.loads(f.read())
...
dt = (
    ...
    .add(
        "产值",
        [
            ["北京", 31626607], ["天津", 1962241], ["河北", 451627], ["上海", 11875920],
            ["江苏", 18796207], ["浙江", 12702283], ["福建", 3012351], ["山东", 14804387],
            ["广东", 27138686], ["海南", 71239], ["山西", 73462], ["安徽", 608469],
            ["江西", 340899], ["河南", 535728], ["湖北", 2139453], ["湖南", 1065716],
            ["内蒙古", 6083], ["广西", 714530], ["重庆", 2762589], ["四川", 6722325],
            ["贵州", 1078845], ["云南", 71020], ["西藏", 0], ["陕西", 3400700],
            ["甘肃", 33253], ["青海", 2845], ["宁夏", 88874], ["新疆", 35221],
            ["辽宁", 2241320], ["吉林", 212194], ["黑龙江", 35946],
        ],
        "china",
    )
...
scatter = (
    ...
    .add_yaxis(
        "本期累计",
        [26583, 70128, 2038, 9376, 524, 12648],
        label_opts=opts.LabelOpts(is_show=False),
    )
    .add_yaxis(
        "同期累计",
        [24179, 62777, 1847, 8425, 509, 11986],
        label_opts=opts.LabelOpts(is_show=False),
    )
)
...
data = pd.read_csv("./相关岗位样例.csv", encoding="GBK")
df = data[["职位", "地区", "要求"]]
